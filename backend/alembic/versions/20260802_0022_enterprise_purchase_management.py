...
def upgrade() -> None:
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("header_discount_amount", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.UniqueConstraint("firm_id", "po_number", name="UQ_purchase_orders_firm_po_number"),
    )
    op.create_index("IX_purchase_orders_firm_id", "purchase_orders", ["firm_id"])
    op.create_index("IX_purchase_orders_tax_profile_id", "purchase_orders", ["tax_profile_id"])
    op.create_index("IX_purchase_orders_firm_status", "purchase_orders", ["firm_id", "status"])
    op.create_index("IX_purchase_orders_firm_date", "purchase_orders", ["firm_id", "purchase_date"])
    op.create_index("IX_purchase_orders_firm_vendor", "purchase_orders", ["firm_id", "vendor_id"])
    op.create_index("IX_purchase_orders_firm_branch", "purchase_orders", ["firm_id", "branch_id"])
    op.create_index("IX_purchase_orders_firm_warehouse", "purchase_orders", ["firm_id", "warehouse_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("base_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
    ...
    op.create_index("IX_purchase_order_lines_firm_id", "purchase_order_lines", ["firm_id"])
    op.create_index("IX_purchase_order_lines_order", "purchase_order_lines", ["purchase_order_id"])
    op.create_index("IX_purchase_order_lines_firm_product", "purchase_order_lines", ["firm_id", "product_id"])
    ...
    op.create_index("IX_purchase_delivery_schedules_purchase_order_line_id", "purchase_delivery_schedules", ["purchase_order_line_id"])
    op.create_index("IX_purchase_delivery_schedules_line", "purchase_delivery_schedules", ["purchase_order_line_id"])
    op.create_index("IX_purchase_delivery_schedules_firm_date", "purchase_delivery_schedules", ["firm_id", "delivery_date"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("attachment_kind", sa.String(length=40), nullable=False, server_default="PURCHASE_FILE"),
        sa.ForeignKeyConstraint(["purchase_order_id"], ["purchase_orders.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["firm_id"], ["firms.id"]),
    )
    op.create_index("IX_purchase_attachments_purchase_order_id", "purchase_attachments", ["purchase_order_id"])
    op.create_index("IX_purchase_attachments_order", "purchase_attachments", ["purchase_order_id"])
    ...
    op.create_index("IX_purchase_notes_purchase_order_id", "purchase_notes", ["purchase_order_id"])
    ...
    op.create_index("IX_purchase_order_history_purchase_order_id", "purchase_order_history", ["purchase_order_id"])
    op.create_index("IX_purchase_order_history_order", "purchase_order_history", ["purchase_order_id"])
    op.create_index("IX_purchase_order_history_firm_action", "purchase_order_history", ["firm_id", "action"])


def downgrade() -> None:
    op.drop_index("IX_purchase_order_history_firm_action", table_name="purchase_order_history")
    op.drop_index("IX_purchase_order_history_order", table_name="purchase_order_history")
    op.drop_index("IX_purchase_order_history_purchase_order_id", table_name="purchase_order_history")
    ...
    op.drop_index("IX_purchase_attachments_purchase_order_id", table_name="purchase_attachments")
    op.drop_table("purchase_attachments")

    op.drop_index("IX_purchase_delivery_schedules_firm_date", table_name="purchase_delivery_schedules")
    op.drop_index("IX_purchase_delivery_schedules_line", table_name="purchase_delivery_schedules")
    op.drop_index("IX_purchase_delivery_schedules_purchase_order_line_id", table_name="purchase_delivery_schedules")
    op.drop_table("purchase_delivery_schedules")

    op.drop_index("IX_purchase_order_lines_firm_product", table_name="purchase_order_lines")
