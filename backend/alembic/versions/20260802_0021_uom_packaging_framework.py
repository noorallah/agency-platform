...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            "dimension", sa.String(length=30), nullable=False, server_default="COUNT"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            "is_base", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column("display_order", sa.Integer(), nullable=False, server_default="0"),
        sa.ForeignKeyConstraint(
            ["uom_group_id"], ["uom_groups.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(["uom_id"], ["uoms.id"], ondelete="RESTRICT"),
        sa.UniqueConstraint(
            "uom_group_id", "uom_id", name="UQ_uom_group_units_group_uom"
        ),
    )
    ...
    op.create_index(
        "IX_uom_conversion_rules_product", "uom_conversion_rules", ["product_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "IX_uom_industry_templates_industry",
        "uom_industry_templates",
        ["industry_type"],
    )
    op.create_index(
        "IX_uom_industry_templates_status", "uom_industry_templates", ["status"]
    )
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["uoms.id"],
            ondelete="RESTRICT",
            name="FK_product_uom_configs_base_uoms",
        ),
        sa.ForeignKeyConstraint(
            ["inventory_uom_id"],
            ["uoms.id"],
        ...
        sa.ForeignKeyConstraint(
            ...
            ["uoms.id"],
            ondelete="RESTRICT",
            name="FK_product_uom_configs_sales_uoms",
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "IX_product_uom_configs_firm_product",
        "product_uom_configs",
        ["firm_id", "product_id"],
    )
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.ForeignKeyConstraint(["product_id"], ["products.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(
            ["parent_level_id"], ["product_packaging_levels.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "IX_product_packaging_levels_product",
        "product_packaging_levels",
        ["firm_id", "product_id"],
    )
    op.create_index(
        "IX_product_packaging_levels_parent",
        "product_packaging_levels",
        ["parent_level_id"],
    )
    op.create_index(
        "IX_product_packaging_levels_barcode", "product_packaging_levels", ["barcode"]
    )
    ...
    op.add_column(
        "products", sa.Column("default_receiving_uom_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "products", sa.Column("default_dispatch_uom_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "products", sa.Column("minimum_sales_uom_id", sa.Uuid(), nullable=True)
    )
    ...
    op.create_foreign_key(
        "FK_products_default_receiving_uom_id",
        "products",
        "uoms",
        ["default_receiving_uom_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "FK_products_default_dispatch_uom_id",
        "products",
        "uoms",
        ["default_dispatch_uom_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "FK_products_minimum_sales_uom_id",
        "products",
        "uoms",
        ["minimum_sales_uom_id"],
        ["id"],
    ...
    op.add_column(
        "inventories",
        sa.Column(
            "display_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
    )
    op.add_column("inventories", sa.Column("display_uom_id", sa.Uuid(), nullable=True))
    op.create_foreign_key(
        "FK_inventories_display_uom_id",
        "inventories",
        "uoms",
        ["display_uom_id"],
        ["id"],
    ...
    op.add_column(
        "inventory_transactions", sa.Column("entered_uom_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "inventory_transactions",
    ...
    op.create_foreign_key(
        "FK_inventory_transactions_entered_uom_id",
        "inventory_transactions",
        "uoms",
        ["entered_uom_id"],
        ["id"],
    ...
    op.create_index(
        "IX_inventory_transactions_entered_uom_id",
        "inventory_transactions",
        ["entered_uom_id"],
    )
    ...
    op.add_column(
        ...
        sa.Column("original_quantity", sa.Numeric(18, 4), nullable=True),
    )
    op.add_column(
        "stock_ledger_entries", sa.Column("original_uom_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "stock_ledger_entries",
    ...
    op.create_foreign_key(
        "FK_stock_ledger_entries_original_uom_id",
        "stock_ledger_entries",
        "uoms",
        ["original_uom_id"],
        ["id"],
    ...
    op.create_index(
        "IX_stock_ledger_entries_original_uom_id",
        "stock_ledger_entries",
        ["original_uom_id"],
    )
    ...
    op.add_column(
        "opening_stock_lines", sa.Column("entered_uom_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "opening_stock_lines",
        sa.Column("conversion_version", sa.Integer(), nullable=True),
    ...
    op.create_foreign_key(
        "FK_opening_stock_lines_entered_uom_id",
        "opening_stock_lines",
        "uoms",
        ["entered_uom_id"],
        ["id"],
    ...
    op.create_index(
        "IX_opening_stock_lines_entered_uom_id",
        "opening_stock_lines",
        ["entered_uom_id"],
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "IX_stock_ledger_entries_original_uom_id", table_name="stock_ledger_entries"
    )
    op.drop_constraint(
        "FK_stock_ledger_entries_original_uom_id",
        "stock_ledger_entries",
    ...
    op.drop_index(
        "IX_inventory_transactions_entered_uom_id", table_name="inventory_transactions"
    )
    op.drop_constraint(
        "FK_inventory_transactions_entered_uom_id",
        "inventory_transactions",
    ...
    op.drop_constraint(
        "FK_inventories_display_uom_id", "inventories", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "FK_products_minimum_sales_uom_id", "products", type_="foreignkey"
    )
    op.drop_constraint(
        "FK_products_default_dispatch_uom_id", "products", type_="foreignkey"
    )
    op.drop_constraint(
        "FK_products_default_receiving_uom_id", "products", type_="foreignkey"
    )
    ...
    op.drop_index(
        "IX_product_packaging_levels_barcode", table_name="product_packaging_levels"
    )
    op.drop_index(
        "IX_product_packaging_levels_parent", table_name="product_packaging_levels"
    )
    op.drop_index(
        "IX_product_packaging_levels_product", table_name="product_packaging_levels"
    )
    op.drop_table("product_packaging_levels")

    op.drop_index(
        "IX_product_uom_configs_firm_product", table_name="product_uom_configs"
    )
    op.drop_table("product_uom_configs")

    op.drop_index(
        "IX_uom_industry_templates_status", table_name="uom_industry_templates"
    )
    op.drop_index(
        "IX_uom_industry_templates_industry", table_name="uom_industry_templates"
    )
    op.drop_table("uom_industry_templates")

    op.drop_index(
        "IX_business_profile_uom_defaults_profile",
        table_name="business_profile_uom_defaults",
    )
    op.drop_table("business_profile_uom_defaults")

    op.drop_index(
        "IX_uom_conversion_rules_effective", table_name="uom_conversion_rules"
    )
