...
def upgrade() -> None:
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("credit_limit_snapshot", sa.Numeric(18, 2), nullable=False, server_default="0"),
        sa.Column("outstanding_balance_snapshot", sa.Numeric(18, 2), nullable=False, server_default="0"),
        ...
        sa.UniqueConstraint("firm_id", "order_number", name="UQ_sales_orders_firm_order_number"),
    )
    op.create_index("IX_sales_orders_firm_status", "sales_orders", ["firm_id", "status"])
    op.create_index("IX_sales_orders_firm_date", "sales_orders", ["firm_id", "order_date"])
    op.create_index("IX_sales_orders_firm_customer", "sales_orders", ["firm_id", "customer_id"])
    op.create_index("IX_sales_orders_firm_branch", "sales_orders", ["firm_id", "branch_id"])
    op.create_index("IX_sales_orders_firm_warehouse", "sales_orders", ["firm_id", "warehouse_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("reservable_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("reserved_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("available_stock", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.ForeignKeyConstraint(
            ["sales_uom_id"],
            ["uoms.id"],
            name="FK_sales_order_lines_sales_uom",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["inventory_uom_id"],
            ["uoms.id"],
            name="FK_sales_order_lines_inventory_uom",
            ondelete="RESTRICT",
        ),
        ...
        sa.UniqueConstraint("sales_order_id", "line_number", name="UQ_sales_order_lines_order_line"),
    )
    op.create_index("IX_sales_order_lines_order", "sales_order_lines", ["sales_order_id"])
    op.create_index("IX_sales_order_lines_firm_product", "sales_order_lines", ["firm_id", "product_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("attachment_kind", sa.String(length=40), nullable=False, server_default="SALES_ORDER_FILE"),
        sa.ForeignKeyConstraint(["sales_order_id"], ["sales_orders.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["firm_id"], ["firms.id"]),
    )
    op.create_index("IX_sales_order_attachments_order", "sales_order_attachments", ["sales_order_id"])
    ...
    op.create_index("IX_sales_order_notes_order", "sales_order_notes", ["sales_order_id"])


def downgrade() -> None:
    op.drop_index("IX_sales_order_notes_order", table_name="sales_order_notes")
    op.drop_table("sales_order_notes")
    op.drop_index("IX_sales_order_attachments_order", table_name="sales_order_attachments")
    op.drop_table("sales_order_attachments")
    op.drop_index("IX_sales_order_lines_firm_product", table_name="sales_order_lines")
    op.drop_index("IX_sales_order_lines_order", table_name="sales_order_lines")
    op.drop_table("sales_order_lines")
    op.drop_index("IX_sales_orders_firm_warehouse", table_name="sales_orders")
    op.drop_index("IX_sales_orders_firm_branch", table_name="sales_orders")
    op.drop_index("IX_sales_orders_firm_customer", table_name="sales_orders")
    op.drop_index("IX_sales_orders_firm_date", table_name="sales_orders")
    op.drop_index("IX_sales_orders_firm_status", table_name="sales_orders")
