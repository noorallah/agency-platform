...
def upgrade() -> None:
    ...
    op.create_index(
        "IX_sales_orders_firm_status", "sales_orders", ["firm_id", "status"]
    )
    op.create_index(
        "IX_sales_orders_firm_date", "sales_orders", ["firm_id", "order_date"]
    )
    op.create_index(
        "IX_sales_orders_firm_customer", "sales_orders", ["firm_id", "customer_id"]
    )
    op.create_index(
        "IX_sales_orders_firm_branch", "sales_orders", ["firm_id", "branch_id"]
    )
    op.create_index(
        "IX_sales_orders_firm_warehouse", "sales_orders", ["firm_id", "warehouse_id"]
    )
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            "reservable_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "reserved_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "available_stock", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "reserved_stock", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "IX_sales_order_lines_firm_product",
        "sales_order_lines",
        ["firm_id", "product_id"],
    )
    ...
    op.create_index(
        "IX_sales_order_attachments_order",
        "sales_order_attachments",
        ["sales_order_id"],
    )
    ...
    op.create_index(
        "IX_sales_order_notes_order", "sales_order_notes", ["sales_order_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "IX_sales_order_attachments_order", table_name="sales_order_attachments"
    )
