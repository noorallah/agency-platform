...
def upgrade() -> None:
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("allow_over_delivery", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("over_delivery_percent", sa.Numeric(9, 4), nullable=False, server_default="0"),
        sa.Column("status", sa.String(length=30), nullable=False, server_default="DRAFT"),
        sa.Column("total_ordered_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("total_previously_delivered_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("total_current_delivery_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.UniqueConstraint("firm_id", "delivery_note_number", name="UQ_delivery_notes_firm_number"),
    )
    op.create_index("IX_delivery_notes_firm_id", "delivery_notes", ["firm_id"])
    op.create_index("IX_delivery_notes_firm_status", "delivery_notes", ["firm_id", "status"])
    op.create_index("IX_delivery_notes_firm_date", "delivery_notes", ["firm_id", "delivery_date"])
    op.create_index("IX_delivery_notes_firm_sales_order", "delivery_notes", ["firm_id", "sales_order_id"])
    op.create_index("IX_delivery_notes_firm_customer", "delivery_notes", ["firm_id", "customer_id"])
    op.create_index("IX_delivery_notes_firm_branch", "delivery_notes", ["firm_id", "branch_id"])
    op.create_index("IX_delivery_notes_firm_warehouse", "delivery_notes", ["firm_id", "warehouse_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("previously_delivered_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("current_delivery_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.Column("remaining_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("damaged_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("short_shipment_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.UniqueConstraint("delivery_note_id", "line_number", name="UQ_delivery_note_lines_note_line"),
    )
    ...
    op.create_index("IX_delivery_note_lines_firm_order_line", "delivery_note_lines", ["firm_id", "sales_order_line_id"])
    op.create_index("IX_delivery_note_lines_firm_product", "delivery_note_lines", ["firm_id", "product_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("attachment_kind", sa.String(length=40), nullable=False, server_default="DELIVERY_NOTE_FILE"),
        sa.ForeignKeyConstraint(["delivery_note_id"], ["delivery_notes.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["firm_id"], ["firms.id"]),
    )
    op.create_index("IX_delivery_note_attachments_delivery_note_id", "delivery_note_attachments", ["delivery_note_id"])
    op.create_index("IX_delivery_note_attachments_note", "delivery_note_attachments", ["delivery_note_id"])
    ...
    op.create_index("IX_delivery_note_notes_delivery_note_id", "delivery_note_notes", ["delivery_note_id"])
    op.create_index("IX_delivery_note_notes_note", "delivery_note_notes", ["delivery_note_id"])


def downgrade() -> None:
    op.drop_index("IX_delivery_note_notes_note", table_name="delivery_note_notes")
    op.drop_index("IX_delivery_note_notes_delivery_note_id", table_name="delivery_note_notes")
    op.drop_table("delivery_note_notes")

    op.drop_index("IX_delivery_note_attachments_note", table_name="delivery_note_attachments")
    op.drop_index("IX_delivery_note_attachments_delivery_note_id", table_name="delivery_note_attachments")
    op.drop_table("delivery_note_attachments")

    op.drop_index("IX_delivery_note_lines_firm_product", table_name="delivery_note_lines")
    op.drop_index("IX_delivery_note_lines_firm_order_line", table_name="delivery_note_lines")
