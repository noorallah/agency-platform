...
def upgrade() -> None:
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("allow_over_return", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("over_return_percent", sa.Numeric(9, 4), nullable=False, server_default="0"),
        sa.Column("status", sa.String(length=30), nullable=False, server_default="DRAFT"),
        sa.Column("total_source_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("total_already_returned_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("total_current_return_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.UniqueConstraint("firm_id", "return_number", name="UQ_purchase_returns_firm_return_number"),
    )
    op.create_index("IX_purchase_returns_firm_id", "purchase_returns", ["firm_id"])
    op.create_index("IX_purchase_returns_firm_status", "purchase_returns", ["firm_id", "status"])
    op.create_index("IX_purchase_returns_firm_date", "purchase_returns", ["firm_id", "return_date"])
    op.create_index("IX_purchase_returns_firm_vendor", "purchase_returns", ["firm_id", "vendor_id"])
    op.create_index("IX_purchase_returns_firm_branch", "purchase_returns", ["firm_id", "branch_id"])
    op.create_index("IX_purchase_returns_firm_warehouse", "purchase_returns", ["firm_id", "warehouse_id"])
    ...
    op.create_index("IX_purchase_return_sources_purchase_return_id", "purchase_return_sources", ["purchase_return_id"])
    op.create_index("IX_purchase_return_sources_return", "purchase_return_sources", ["purchase_return_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("already_returned_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        sa.Column("current_return_quantity", sa.Numeric(18, 4), nullable=False, server_default="0"),
        ...
        sa.Column("replacement_required", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("refund_required", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.UniqueConstraint("purchase_return_id", "line_number", name="UQ_purchase_return_lines_return_line"),
    )
    op.create_index("IX_purchase_return_lines_purchase_return_id", "purchase_return_lines", ["purchase_return_id"])
    op.create_index("IX_purchase_return_lines_return", "purchase_return_lines", ["purchase_return_id"])
    op.create_index("IX_purchase_return_lines_firm_source", "purchase_return_lines", ["firm_id", "source_document_line_id"])
    op.create_index("IX_purchase_return_lines_firm_product", "purchase_return_lines", ["firm_id", "product_id"])
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column("attachment_kind", sa.String(length=40), nullable=False, server_default="PURCHASE_RETURN_FILE"),
        sa.ForeignKeyConstraint(["purchase_return_id"], ["purchase_returns.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["firm_id"], ["firms.id"]),
    )
    op.create_index("IX_purchase_return_attachments_purchase_return_id", "purchase_return_attachments", ["purchase_return_id"])
    op.create_index("IX_purchase_return_attachments_return", "purchase_return_attachments", ["purchase_return_id"])
    ...
    op.create_index("IX_purchase_return_notes_purchase_return_id", "purchase_return_notes", ["purchase_return_id"])
    op.create_index("IX_purchase_return_notes_return", "purchase_return_notes", ["purchase_return_id"])
    ...
    op.create_index("IX_purchase_return_accounting_events_purchase_return_id", "purchase_return_accounting_events", ["purchase_return_id"])
    op.create_index("IX_purchase_return_accounting_events_return", "purchase_return_accounting_events", ["purchase_return_id"])
    op.create_index("IX_purchase_return_accounting_events_type", "purchase_return_accounting_events", ["firm_id", "event_type"])


def downgrade() -> None:
    op.drop_index("IX_purchase_return_accounting_events_type", table_name="purchase_return_accounting_events")
    op.drop_index("IX_purchase_return_accounting_events_return", table_name="purchase_return_accounting_events")
    op.drop_index("IX_purchase_return_accounting_events_purchase_return_id", table_name="purchase_return_accounting_events")
    ...
    op.drop_index("IX_purchase_return_notes_purchase_return_id", table_name="purchase_return_notes")
    op.drop_table("purchase_return_notes")

    op.drop_index("IX_purchase_return_attachments_return", table_name="purchase_return_attachments")
    op.drop_index("IX_purchase_return_attachments_purchase_return_id", table_name="purchase_return_attachments")
    op.drop_table("purchase_return_attachments")

    op.drop_index("IX_purchase_return_lines_firm_product", table_name="purchase_return_lines")
    op.drop_index("IX_purchase_return_lines_firm_source", table_name="purchase_return_lines")
    op.drop_index("IX_purchase_return_lines_return", table_name="purchase_return_lines")
    op.drop_index("IX_purchase_return_lines_purchase_return_id", table_name="purchase_return_lines")
    op.drop_table("purchase_return_lines")

    op.drop_index("IX_purchase_return_sources_return", table_name="purchase_return_sources")
    op.drop_index("IX_purchase_return_sources_purchase_return_id", table_name="purchase_return_sources")
