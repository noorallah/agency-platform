...
| 2.13b | As `master.ops`: delete a user, choose **Deleted** in the Users grid's **Firm** filter, open them (status **Deleted**, Edit and Delete dead, View opens) → **Restore** in the dialog footer; sign in as them | Back in the grid with their old firms and roles, and the old password works. |
