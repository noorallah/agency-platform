...
| 7.4 | Select the approved order → **Edit** | A dialog titled **Editing withdraws the approval** says changing it returns the order to Draft and it will need submitting and approving again. Click **Edit anyway**, change the remarks, Save. Status is **DRAFT** again and the **History** section of the view shows the approval withdrawn; a line remark typed here is kept. (Until 2026-09-12 every edit of a saved order was refused with a 422 the editor barely showed -- BACKLOG §31.10.) Submit and Approve it once more before 7.5. |
