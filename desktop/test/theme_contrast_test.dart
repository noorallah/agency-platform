  ...
  for (final AppPalette palette in AppPalette.values) {
    for (final Brightness brightness in Brightness.values) {
      ...
      final ThemeData theme =
          ThemeRegistry.themeFor(palette: palette, brightness: brightness);
      ...
      final Map<String, (Color, Color, double)> pairs = {
        ...
        'body text on a header row': (c.onSurface, c.surfaceContainerLow, _text),
        ...
        'success text on a card': (s.success, c.surfaceContainerLowest, _text),
        'warning text on a card': (s.warning, c.surfaceContainerLowest, _text),
